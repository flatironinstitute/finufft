...
NVCCFLAGS=-DSPREADTIME -arch=sm_50#If using any card with architecture KXX, change to -arch=sm_30 (see GPUs supported section in https://en.wikipedia.org/wiki/CUDA for more info)
...
spread2d: examples/spread_2d.o src/2d/spread2d_wrapper.o \
	src/2d/spread2d_wrapper_paul.o  src/2d/spread2d.o \

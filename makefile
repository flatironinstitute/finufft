...
NVCCFLAGS=-arch=sm_50 -DTIME -DSPREADTIME -DDEBUG#If using any card with 
#architecture KXX, change to -arch=sm_30 (see GPUs supported section in https://en.wikipedia.org/wiki/CUDA for more info)

#ifndef COMMON_LEGACY_H
#define COMMON_LEGACY_H

#include <fftw_defs_legacy.h>
#include <nufft_opts.h>
#include <spreadinterp_legacy.h>
...
void onedim_dct_kernel(BIGINT nf, FLT *fwkerhalf, FLT opts);

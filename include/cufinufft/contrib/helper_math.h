...
__host__ __device__ __forceinline__ cuDoubleComplex operator+(
    const cuDoubleComplex &a, const cuDoubleComplex &b) {
  return cuCadd(a, b);
}
...
__host__ __device__ __forceinline__ cuDoubleComplex operator+(
    double a, const cuDoubleComplex &b) {
...
__host__ __device__ __forceinline__ cuFloatComplex operator+(
    const cuFloatComplex &a, const cuFloatComplex &b) {
  return cuCaddf(a, b);
}
...
__host__ __device__ __forceinline__ cuFloatComplex operator+(
    float a, const cuFloatComplex &b) {
...
__host__ __device__ __forceinline__ cuDoubleComplex &operator+=(
    cuDoubleComplex &a, const cuDoubleComplex &b) {
  a = cuCadd(a, b);
  return a;
}
...
__host__ __device__ __forceinline__ cuFloatComplex &operator+=(
    cuFloatComplex &a, const cuFloatComplex &b) {
  a = cuCaddf(a, b);
  return a;
}

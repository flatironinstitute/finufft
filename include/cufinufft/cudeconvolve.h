...
void Deconvolve_2d(int ms, int mt, int nf1, int nf2, int fw_width, CUCPX* fw, 
	CUCPX *fk, CUFINUFFT_FLT *fwkerhalf1, CUFINUFFT_FLT *fwkerhalf2);
__global__
...
void Deconvolve_3d(int ms, int mt, int mu, int nf1, int nf2, int nf3, 
	int fw_width, CUCPX* fw, CUCPX *fk, CUFINUFFT_FLT *fwkerhalf1, CUFINUFFT_FLT *fwkerhalf2, 
	CUFINUFFT_FLT *fwkerhalf3);
__global__
void Amplify_3d(int ms, int mt, int mu, int nf1, int nf2, int nf3, int fw_width, 
	CUCPX* fw, CUCPX *fk, CUFINUFFT_FLT *fwkerhalf1, CUFINUFFT_FLT *fwkerhalf2, CUFINUFFT_FLT *fwkerhalf3);

// Wrappers for natural input calling from fortran.
// These are like C wrappers except everything is passed by reference.

// See cnufftspread_c.h for documentation.

// Magland Dec 2016. Barnett added ier, changed name to _f, 1/17/17
...
void twopispread1d_f_(int *N1,int *N2,int *N3,double *d_uniform,int *M,double *kx,double *ky,double *kz,double *d_nonuniform,int *spread_direction,double *kernel_params, int *ier)
{
  if (kernel_params[0]!=1) {
    printf("Error: Unexpected kernel type.\n");
    return;

...
c     Test of legacy interface only --- remove when fully deprecated.
c
...
c
c     gfortran nufft1d_demo_legacyf.f ../directft/dirft1df.f
c     -o nufft1d_demo_legacyf
c     ../../lib-static/libfinufftf.a -lstdc++ -lfftw3f -lfftw3f_omp -lm -fopenmp
c
      program nufft1d_demo_legacyf
      implicit none
c
c --- local variables
c
...
c
         ...
         call finufftf1d1_f(nj,xj,cj,iflag,eps,ms,fk1,ier)
...
c
         ...
         call finufftf1d2_f(nj,xj,cj1,iflag, eps, ms,fk0,ier)
...
c     -----------------------
         ...
         call finufftf1d3_f(nj,xj,cj,iflag,eps, ms,sk,fk1,ier)
         call errcomp(cj0,cj1,nj,err)
         print *,' ier = ',ier

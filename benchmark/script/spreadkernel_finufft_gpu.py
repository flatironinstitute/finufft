...
def main():
	...
	for i,N in enumerate(N_totry):
		...
		t = 0
		for n in range(reps):
                        output=subprocess.check_output(["./compare",'1',str(N),str(N)], \
                                            cwd="../").decode("utf-8")
		...
		t = 0
		for n in range(reps):
                        output=subprocess.check_output(["./compare",'2',str(N),str(N)], \
                                            cwd="../").decode("utf-8")
                        t+= float(find_between(output, "Spread", "ms"))
		...
		t = 0
		for n in range(reps):
                        output=subprocess.check_output(["./compare",'3',str(N),str(N)], \
                                            cwd="../").decode("utf-8")
                        t+= float(find_between(output, "Spread", "ms"))
		...
		t = 0
		for n in range(reps):
                        output=subprocess.check_output(["./compare",'4',str(N),str(N)], \
                                            cwd="../").decode("utf-8")
                        t+= float(find_between(output, "Spread", "ms"))

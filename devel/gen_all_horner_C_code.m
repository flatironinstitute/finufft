...
for upsampfac = [2.0, 1.25];   % sigma: either 2 (default) or low (eg 5/4)
  ...
  if upsampfac==2, fid = fopen('../inclue/cuda/contrib/ker_horner_allw_loop_constexpr.inc','w');
  else, fid = fopen('../inclue/cuda/contrib/ker_lowupsampfac_horner_allw_loop_constexpr.inc','w');
  end

...
project = "finufft"
copyright = "2017-2026 The Simons Foundation, Inc. - All Rights Reserved"
author = "Alex Barnett, Ludvig af Klinteberg, Joakim Andén, Libin Lu, Jeremy Magland, Andrea Malleo, Yu-Hsuan Shih, Marco Barbone, Robert Blackwell, Martin Reinecke, and others."
...
latex_documents = [
    (
        ...
        "Alex Barnett and the FINUFFT team",
        "manual",
        False,
    ),
]
...
man_pages = [(master_doc, "finufft", "FINUFFT Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        "FINUFFT Documentation",
        author,
        "FINUFFT nonuniform FFT",
        "Nonuniform FFT of types 1,2,3 in dimensions 1,2,3",
        "Numerical methods",
    ),
]

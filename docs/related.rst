...
- `DUCC <https://github.com/mreineck/ducc>`__: Reinecke's amazing C++ package contains `NUFFT code <https://github.com/mreineck/ducc/tree/ducc0/src/ducc0/nufft>`__, developed for radio-astronomy, that in some regimes is faster than ours (due to the use of variable upsampling factor; we are catching up, with his help).

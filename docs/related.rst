...
- `NFFT.jl <https://github.com/JuliaMath/NFFT.jl>`_ native Julia implementation for type 1 and 2 only, by Tobias Knopp and coworkers, starting around 2022. See :doc:`page on Julia <julia>`.

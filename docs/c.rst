...
with the word "many" in the function name) perform ``ntr`` transforms with the same set of nonuniform points but stacked complex strength or coefficient vectors.

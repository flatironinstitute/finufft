...
template void cuinterp3d<float>(const cufinufft_plan_t<float> &d_plan, cuda_complex<float> *c, const cuda_complex<float> *fw, int blksize);
template void cuinterp3d<double>(const cufinufft_plan_t<double> &d_plan, cuda_complex<double> *c, const cuda_complex<double> *fw, int blksize);

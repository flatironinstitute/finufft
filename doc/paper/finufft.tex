...
One must apply the saddle point theorem to the left and right half of the
contour separately, and sum the contributions.
...
as at the saddle points.
However, it is easy to show that contribution of each endpoint can be 


Thus we will split the contour at its half-way point.




condition of the saddle point theorem
is that $p$ is uniformly 

assumption

must also exclude
the part of the contour near $z=\pm1$, since
***

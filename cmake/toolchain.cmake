...
string(TOUPPER "${FINUFFT_ENABLE_SANITIZERS}" FINUFFT_ENABLE_SANITIZERS_MODE)
if(FINUFFT_ENABLE_SANITIZERS_MODE STREQUAL "OFF")
elseif(FINUFFT_ENABLE_SANITIZERS_MODE STREQUAL "ON" OR FINUFFT_ENABLE_SANITIZERS_MODE STREQUAL "MEMSAN")
    set(FINUFFT_SANITIZER_FLAGS
        -fsanitize=address
        -fsanitize=undefined
...
elseif(FINUFFT_ENABLE_SANITIZERS_MODE STREQUAL "TSAN")
    set(FINUFFT_SANITIZER_FLAGS -fsanitize=thread)
else()
    message(
        FATAL_ERROR
        "Unsupported FINUFFT_ENABLE_SANITIZERS value '${FINUFFT_ENABLE_SANITIZERS}'. Use one of: OFF, ON, MEMSAN, TSAN."
    )
endif()

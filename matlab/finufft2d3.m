...
mex_id_ = 'o int = finufft2d3m(i double, i double[], i double[], i dcomplex[x], i int, i double, i double, i double[], i double[], o dcomplex[x], i int, i double, i int, i int)';
[ier, f] = finufft(mex_id_, nj, x, y, c, isign, eps, nk, s, t, debug, maxnalloc, nthreads, spread_sort, nj, nk);

...
int finufft1d3m(double nj,double* xj,dcomplex* cj,int iflag,double eps,double nk, double* s, dcomplex* f, int debug, int nthreads, int spread_sort, int fftw_style);
...
int finufft2d3m(double nj,double* xj,double* yj,dcomplex* cj,int iflag,double eps,double nk, double* s, double* t, dcomplex* f, int debug, int nthreads, int spread_sort, int fftw_style);
...
int finufft3d3m(double nj,double* xj,double* yj,double*zj, dcomplex* cj,int iflag,double eps,double nk, double* s, double* t, double* u, dcomplex* f, int debug, int nthreads, int spread_sort, int fftw_style);

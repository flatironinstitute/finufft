...
mex_id_ = 'o int = finufft2d2m(i double, i double[], i double[], o dcomplex[x], i int, i double, i double, i double, i dcomplex[], i int, i int, i int, i int, i int)';
[ier, c] = finufft(mex_id_, nj, x, y, isign, eps, ms, mt, f, debug, nthreads, spread_sort, fftw, modeord, nj);

...
mex_id_ = 'o int = finufft1d3m(i double, i double[], i dcomplex[x], i int, i double, i double, i double[], o dcomplex[x], i int, i double, i int)';
[ier, f] = finufft(mex_id_, nj, x, c, isign, eps, nk, s, debug, maxnalloc, nthreads, nj, nk);

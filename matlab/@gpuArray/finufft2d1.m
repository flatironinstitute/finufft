% FINUFFT2D1   GPU 2D complex nonuniform FFT of type 1 (nonuniform to uniform).
%
...
%
% Notes:
%  * FINUFFT?M? is overloaded for gpuArrays, returning a gpuArray.
...
function f = finufft2d1(x,y,c,isign,eps,ms,mt,varargin)
f = cufinufft2d1(x,y,c,isign,eps,ms,mt,varargin{:});

...
//    Setup the inputs
        ...
        //isign
        double *p_input_isign=mxGetPr(prhs[6-1]);
        ...
        double *input_nonuniform_locations=mxGetPr(prhs[4-1]);
        ...
        double *input_nonuniform_data_re=mxGetPr(prhs[5-1]);
        double *input_nonuniform_data_im=mxGetPi(prhs[5-1]);
...
//    Setup the outputs
        ...
        output_uniform_data=(double *)malloc(sizeof(double)*((input_N1)*(input_N2)*(input_N3))*2);

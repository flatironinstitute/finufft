...
register({
  check: function (argTypes, nargout) {
    ...
    return { outputTypes: [IType.tensor({ isComplex: true })] };
  },
  apply: function (args, nargout) {
    ...
    var ier = exports.guru_execute(handle, in_re_ptr, in_im_ptr, n_in,
                                   out_re_ptr, out_im_ptr, n_out);

    // Copy output from WASM

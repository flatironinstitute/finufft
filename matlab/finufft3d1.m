...
mex_id_ = 'o int = finufft3d1m(i double, i double[], i double[], i double[], i dcomplex[], i int, i double, i double, i double, i double, o dcomplex[x], i int, i int, i int, i int)';
[ier, f] = finufft(mex_id_, nj, x, y, z, c, isign, eps, ms, mt, mu, debug, nthreads, spread_sort, fftw, mtot);

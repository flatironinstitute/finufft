...
int finufft1d3m(double nj,double* xj,dcomplex* cj,int iflag,double eps,double nk, double* s, dcomplex* fk, int debug, int nthreads, int spread_sort, int fftw_style)
  {
  nufft_opts opts;
  opts.debug = debug; opts.spread_sort=spread_sort;
  opts.fftw = !fftw_style ? FFTW_ESTIMATE : FFTW_MEASURE;
...
int finufft2d3m(double nj,double* xj,double *yj,dcomplex* cj,int iflag,double eps,double nk, double* s, double* t, dcomplex* fk, int debug, int nthreads, int spread_sort, int fftw_style)
  {
  nufft_opts opts;
  opts.debug = debug; opts.spread_sort=spread_sort;
  opts.fftw = !fftw_style ? FFTW_ESTIMATE : FFTW_MEASURE;  
...
int finufft3d3m(double nj,double* xj,double *yj,double *zj,dcomplex* cj,int iflag,double eps,double nk, double* s, double* t, double *u, dcomplex* fk, int debug, int nthreads, int spread_sort, int fftw_style)
  {
  nufft_opts opts;
  opts.debug = debug; opts.spread_sort=spread_sort;
  opts.fftw = !fftw_style ? FFTW_ESTIMATE : FFTW_MEASURE;
